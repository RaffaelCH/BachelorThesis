...
public final class DependencyHierarchicalASTVisitor extends HierarchicalASTVisitor {
    ...
    public boolean visit(Type node) {
        ...
        graph.addNode(new Node.Builder()
                ...
                .withDeclaringScopesName(declaringClassName)
    ...
    public boolean visit(MethodDeclaration node) {
        ...
        final String declaringScopesNameSource = concatDeclaringClassNames(node);
        final String source = concatSave(packageName, declaringScopesNameSource);
        ...
        graph.addNode(new Node.Builder()
                ...
                .withName(name)
                .withDeclaringScopesName(declaringScopesNameSource)
    ...
    public boolean visit(MethodInvocation node) {
        ...
        final String declaringScopesNameTarget = extractDeclaringClassNames(target, declaringPackage, declaringClassName);
        final String declaringScopesNameMethodTarget = extractDeclaringClassNames(target, declaringPackage, "");
        ...
        final String containingTargetNodeId = declaringScopesNameTarget != null ? concatSave(declaringPackage, declaringScopesNameTarget) : null;
        final String containingMethodTargetNodeId = declaringScopesNameMethodTarget != null ? concatSave(declaringPackage, declaringScopesNameMethodTarget)
                : null;
        ...
        graph.addNode(new Node.Builder()
                ...
                .withDeclaringScopesName(declaringScopesNameTarget)
        ...
        graph.addNode(new Node.Builder()
                ...
                .withDeclaringScopesName(declaringScopesNameMethodTarget)
                .withPackageName(declaringPackage)
    ...
    public boolean visit(TypeDeclaration node) {
        ...
        if (node.getSuperclassType() != null) {
            ...
            graph.addNode(new Node.Builder()
                    ...
                    .withDeclaringScopesName(getDeclaringClassName(declaringSuperClass))
        ...
        node.superInterfaceTypes().stream().forEach(i -> {
            ...
            graph.addNode(new Node.Builder()
                    ...
                    .withDeclaringScopesName(containingInterfaceName)
        ...
        graph.addNode(new Node.Builder()
                ...
                .withDeclaringScopesName(declaringClassNames)
                .withPackageName(packageName)
